...
data_by_gen = {
    CURRENT_GEN: fetch_and_clean_ps_data(
        "https://raw.githubusercontent.com/Kaskade-Showdown/kaskade-showdown/master/data/moves.ts"
    )
}

for gen in range(1, CURRENT_GEN):
    data_by_gen[gen] = fetch_and_clean_ps_data(
        f"https://raw.githubusercontent.com/Kaskade-Showdown/kaskade-showdown/master/data/mods/gen{gen}/moves.ts"
    )
